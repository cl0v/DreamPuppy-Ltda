          ...
          <a href="https://example.com" target="_blank" rel="noreferrer noopener">
            <slot name="link1">
              ...
              <div class="footer4-fragment3">
                <span class="footer4-text16 thq-body-small">Link 1</span>
              </div>
            </slot>
          </a>
          <a href="https://example.com" target="_blank" rel="noreferrer noopener">
            <slot name="link2">
              ...
              <div class="footer4-fragment5">
                <span class="footer4-text18 thq-body-small">Link 2</span>
              </div>
            </slot>
          </a>
          <a href="https://example.com" target="_blank" rel="noreferrer noopener">
            <slot name="link3">
              ...
              <div class="footer4-fragment2">
                <span class="footer4-text15 thq-body-small">Link 3</span>
              </div>
            </slot>
          </a>
          <a href="https://example.com" target="_blank" rel="noreferrer noopener">
            <slot name="link4">
              ...
              <div class="footer4-fragment6">
                <span class="footer4-text19 thq-body-small">Link 4</span>
              </div>
            </slot>
          </a>
          <a href="https://example.com" target="_blank" rel="noreferrer noopener">
            <slot name="link5">
              ...
              <div class="footer4-fragment1">
                <span class="footer4-text14 thq-body-small">Link 5</span>
              </div>
            </slot>
          </a>
        </div>
            ...
            <span>
              <slot name="privacyLink">
                ...
                <div class="footer4-fragment8">
                  <span class="footer4-text21 thq-body-small">
                    Privacy Policy
                  </span>
                </div>
              </slot>
            ...
            <span>
              <slot name="termsLink">
                ...
                <div class="footer4-fragment4">
                  <span class="footer4-text17 thq-body-small">
                    Terms of Service
                  </span>
                </div>
              </slot>
            ...
            <span>
              <slot name="cookiesLink">
                ...
                <div class="footer4-fragment7">
                  <span class="footer4-text20 thq-body-small">
                    Cookies Settings
                  </span>
                </div>
              </slot>
