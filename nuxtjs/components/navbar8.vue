                    ...
                    <div class="navbar8-content1">
                      <span>
                        <slot name="page1">
                          ...
                          <div><span>Page One</span></div>
                        </slot>
                      </span>
                      <span>
                        <slot name="page1Description">
                          <!--Default content for page1Description-->
                          <div><span>Page One Description</span></div>
                        </slot>
                      </span>
                    </div>
                  </div>
                    ...
                    <div class="navbar8-content2">
                      <span>
                        <slot name="page2">
                          ...
                          <div><span>Page Two</span></div>
                        </slot>
                      </span>
                      <span>
                        <slot name="page2Description">
                          <!--Default content for page2Description-->
                          <div><span>Page Two Description</span></div>
                        </slot>
                      </span>
                    </div>
                  </div>
                    ...
                    <div class="navbar8-content3">
                      <span>
                        <slot name="page3">
                          ...
                          <div><span>Page Three</span></div>
                        </slot>
                      </span>
                      <span>
                        <slot name="page3Description">
                          <!--Default content for page3Description-->
                          <div><span>Page Three Description</span></div>
                        </slot>
                      </span>
                    </div>
                  </div>
                    ...
                    <div class="navbar8-content4">
                      <span>
                        <slot name="page4">
                          ...
                          <div><span>Page Four</span></div>
                        </slot>
                      </span>
                      <span>
                        <slot name="page4Description">
                          <!--Default content for page4Description-->
                          <div><span>Page Four Description</span></div>
                        </slot>
                      </span>
                    </div>
                  </div>
              ...
              <span>
                <slot name="action1">
                  ...
                  <div class="navbar8-fragment11">
                    <span class="navbar8-text15">Main Action</span>
                  </div>
                </slot>
              </span>
            </button>
              ...
              <span>
                <slot name="action2">
                  ...
                  <div class="navbar8-fragment23">
                    <span class="navbar8-text27">Secondary Action</span>
                  </div>
                </slot>
              </span>
            </button>
                ...
                <span>
                  <slot name="page1">
                    ...
                    <div class="navbar8-fragment13">
                      <span class="navbar8-text17 thq-body-large">Page One</span>
                    </div>
                  </slot>
                </span>
                <span>
                  <slot name="page1Description">
                    ...
                    <div class="navbar8-fragment18">
                      <span class="navbar8-text22 thq-body-small">
                ...
                <span>
                  <slot name="page2">
                    ...
                    <div class="navbar8-fragment16">
                      <span class="navbar8-text20 thq-body-large">Page Two</span>
                    </div>
                  </slot>
                </span>
                <span>
                  <slot name="page2Description">
                    ...
                    <div class="navbar8-fragment19">
                      <span class="navbar8-text23 thq-body-small">
                ...
                <span>
                  <slot name="page3">
                    ...
                    <div class="navbar8-fragment21">
                      <span class="navbar8-text25 thq-body-large">
                        Page Three
                      </span>
                    </div>
                  </slot>
                ...
                <span>
                  <slot name="page4">
                    ...
                    <div class="navbar8-fragment15">
                      <span class="navbar8-text19 thq-body-large">Page Four</span>
                    </div>
                  </slot>
                </span>
                <span>
                  <slot name="page4Description">
                    ...
                    <div class="navbar8-fragment10">
                      <span class="navbar8-text14 thq-body-small">
